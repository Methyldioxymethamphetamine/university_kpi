...
of scope — stop and return to the three checks.
  ...
  In the same docling.json, locate the string
      3750000(Three Lakh Seventy Five Thousand)
  ...
  Report the actual page_no and bbox values.
...
Build exactly these, and nothing beyond them:
  ...
  - Enable: ROBOTSTXT_OBEY, AUTOTHROTTLE, JOBDIR (resumable), a real User-Agent
